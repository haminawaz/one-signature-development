...
const services = [
  {
    ...
    description:
      "Walkable, lifestyle-driven spaces for work + living",
  },
  {
    icon: <Building size={36} />,
    title: "Build-to-Sell Communities",
    description:
      "High-yield flips and duplexes in growth corridors",
  },
  {
    icon: <Map size={36} />,
    title: "Build-to-Rent Neighborhoods",
    description:
      "Stabilized long-term rental projects",
  },
  {
    icon: <BarChart3 size={36} />,
    title: "Strategic Land Development",
    description:
      "Acquisitions in path-of-growth markets",
  },
  {
    icon: <Users size={36} />,
